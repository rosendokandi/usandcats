  ...
  return (
    <main className="flex-grow w-full max-w-5xl mx-auto px-4 md:px-margin-desktop py-12 md:py-16 relative">
      ...
      <div className="text-center mb-12 md:mb-16 relative z-10">
        <span className="inline-block px-4 py-1 bg-primary-container text-on-primary-container font-pixel text-xs mb-4 pixel-border-sm shadow-pixel-sm">
          浪漫足迹
        </span>
        <h1 className="font-display font-black text-3xl md:text-5xl text-primary dark:text-primary-fixed tracking-tight">
          一起走过的每一步
        </h1>
        <p className="font-body text-sm md:text-base text-on-surface-variant dark:text-surface-dim mt-3 max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2">
            {categories.map((c) => (
              <button
                ...
                className={`pixel-btn-sm px-3 py-1.5 font-pixel text-xs transition-all ${
